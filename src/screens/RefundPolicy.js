...
class About extends PureComponent {
  ...
  componentDidMount () {
    this.props.navigation.setParams({
      headerTitle: this.props.language['Refund Policy'],
  ...
  constructor (props) {
    ...
    this.state = {
      isLoading: false,
      spinnerTemp: false,
      refundPolicy: this.props.settings
    }
  }
    ...
    return (
      this.state.spinnerTemp ? (
        ...
        <ScrollView showsVerticalScrollIndicator={false} style={{
          ...
          {this.state.refundPolicy !== undefined && this.state.refundPolicy !== ''
            ? <View>
              <HTML
...
const getSettings = (state) => state.settingsCall.refundPolicy
