...
class CartScreen extends PureComponent {
  ...
  //   this.state.cartSubTotalFloat = 0;
  //   var total = 0;
  //   var subTotal = 0;
  ...
  calculateFinalPrice (data) {
    ...
    this.setState({
      cartSubTotalFloat: subTotal,
      cartTotalFloat: total,
      cartDiscountFloat: subTotal - total,
    });
  }
  ...
  applyCouponCart = coupon => {
    ...
    if (coupon.individual_use === 1) {
      this.props.cartProductsArray = JSON.parse(
        JSON.stringify(this.props.cartProductsArray),
      );
      this.props.coupon = [];
    }
    const v = {};
  ...
  couponView = () => (
    <View
      ...
      <Button
        ...
        disable={this.state.couponText.length > 0}
        themeStyle={this.props.themeStyle}
        navigation={this.props.navigation}
        title={this.props.language.Apply}
      />

      {this.props.coupon.map((value, index) => (
        <View
          key={index}
          style={{
            borderColor: '#e8eaeb',
          ...
          <View
            ...
            <Text
              ...
              {this.props.language.Coupon + ' ' + '(' + value.code + ')'}
            </Text>
            <Text
              style={[
                styles.priceText,
              ...
              {'-' +
                ...
                ' ' +
                this.state.cartDiscountFloat.toFixed(2)}
            </Text>
          </View>
    ...
    <View style={styles.priceRow}>
      ...
      <View style={{flexDirection: 'row', paddingRight: 0}}>
        <Text
          ...
          {/* Its take currency symbol dynamically (dollar) but we need only rupes so add symbol static */}
          {/* {this.props.currencySymbol} */}₹
        </Text>
        <Text
          style={[
            ...
            ListHeaderComponent={
              <View style={styles.headerListStyle}>
                  ...
                  ? this.props.cartProductsArray.map((data, index) => (
                      <CartCard
                        ...
                        deleteProductFromCartCall={
                          this.props.deleteProductFromCartCall
                        }
                ...
                <View
                  ...
                  {this.singleRow(
                    this.props.language.SubTotal,
                    this.state.cartSubTotalFloat,
                  )}
                  {this.singleRow(
                    this.props.language.Discount,
                    this.state.cartDiscountFloat,
                  )}
                  <View style={{marginVertical: 5}} />
                  {this.singleRow(
                    this.props.language.OrderTotal,
                  ...
                  {this.props.banners !== undefined ? (
                    this.props.banners.length > 0 ? (
                      <ImageLoad
                        ...
                        source={{
                          uri: this.props.banners[0].banners_image,
                        }}
                      />
                    ) : null
                  ) : null}
                ...
                <View
                  ...
                  {this.categoryHeading(this.props.language['JUST FOR YOU'])}
                </View>
              </View>
            }
...
const mapDispatchToProps = dispatch => ({
  ...
  getProductsFun: (props, page, th) => {
    ...
    // });
      ...
      await getcartRelatedProducts(dispatch, page, th.props.languageCode, 
        th.props.currencyCode, th.props)
