          ...
          <ScrollView>
            <View
              ...
              <View style={{width: '33%'}}>
                <TouchableOpacity
                  onPress={() =>
                    this.props.navigation.push('NewestScreen', {id: 420})
                  }>
                  <Text style={styles.text}>Shillong</Text>
                  <View style={{margin: 5}}>
                    <Image
                      style={styles.image}
                      source={require('../../../images/districtimages/shillong.jpg')}
                    />
                  </View>
                </TouchableOpacity>
              </View>
