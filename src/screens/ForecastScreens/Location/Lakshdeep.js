...
class Lakshdeep extends Component{
    render(){
        return(
            <View style={{flex:1}}>
                <HeaderForecast name={"Lakshdeep"}/>
                <LinearGradient
          ...
          style={{flex: 1}}>
                <ScrollView>
                    <View style={{flexDirection:'row', justifyContent:'center',flexWrap:'wrap',marginBottom:20}}>
                        <View style={{width:'33%'}}>
                            <TouchableOpacity onPress={()=>this.props.navigation.push('NewestScreen',{id:403})}>
                                <Text style={styles.text}>Minicoy</Text>
                                <View style={{margin:5}}>
                                    <Image
                                        style={styles.image}
                                        source={require('../../../images/districtimages/minicoy.jpg')}
                                    />
                                </View>
                            </TouchableOpacity>
                        </View>
