...
class KannurAirTurbulance extends Component{
    render(){
        return(
            <View style={{flex:1}}>
                <HeaderForecast name={"Kannur Air Turbulance"}/>
                <LinearGradient
          ...
          style={{flex: 1}}>
                ...
                <ScrollView>
                    <View style={{flexDirection:'row', justifyContent:'center',flexWrap:'wrap',marginBottom:20}}>
                        <View style={{width:'33%'}}>
                            <TouchableOpacity onPress={()=>this.props.navigation.push('NewestScreen',{id:399})}>
                                <Text style={styles.text}>Clear Air Turbulance 200 HPa</Text>
                                <View style={{margin:5}}>
                                    <Image
                                        style={styles.image}
                                        source={require('../../../images/africaforecast/africawind500.png')}
                                    />
                                </View>
                            </TouchableOpacity>
                        </View>
...
export default KannurAirTurbulance;