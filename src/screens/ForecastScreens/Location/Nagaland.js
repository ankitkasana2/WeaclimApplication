...
const data = [
  {
    id: 423,
    heading: 'Kohima',
    src: require('../../../images/districtimages/kohima.jpg'),
    navigateTo: 'NewestScreen',
  },
  {
    id: 424,
    heading: 'Kohima-dimapur',
    src: require('../../../images/districtimages/dimapur.jpg'),
    navigateTo: 'NewestScreen',
  },
  {
    id: 425,
    heading: 'Mokokchung',
    src: require('../../../images/districtimages/mokokchung.jpg'),
    navigateTo: 'NewestScreen',
  },
];
...
//                         <View style={{width:'33%'}}>
//                             <TouchableOpacity >
//                                 <Text style={styles.text}>Kohima</Text>
//                                 <View style={{margin:5}}>
//                                     <Image
//                                         style={styles.image}
//                                         source={require('../../../images/districtimages/kohima.jpg')}
//                                     />
//                                 </View>
//                             </TouchableOpacity>
//                         </View>
//                         <View style={{width:'33%'}}>
//                             <TouchableOpacity >
//                                 <Text style={styles.text}>Kohima-dimapur</Text>
//                                 <View style={{margin:5}}>
//                                     <Image
//                                         style={styles.image}
//                                         source={require('../../../images/districtimages/dimapur.jpg')}
//                                     />
//                                 </View>
//                             </TouchableOpacity>
//                         </View>
//                         <View style={{width:'33%'}}>
//                             <TouchableOpacity >
//                                 <Text style={styles.text}>Mokokchung</Text>
//                                 <View style={{margin:5}}>
//                                     <Image
//                                         style={styles.image}
//                                         source={require('../../../images/districtimages/mokokchung.jpg')}
//                                     />
//                                 </View>
//                             </TouchableOpacity>
//                         </View>
