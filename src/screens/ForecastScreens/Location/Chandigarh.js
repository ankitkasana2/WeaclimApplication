...
class Chandigarh extends Component{
    render(){
        return(
            <View style={{flex:1}}>
                <HeaderForecast name={"Chandigarh"}/>
                <LinearGradient
          ...
          style={{flex: 1}}>
                <ScrollView>
                    <View style={{flexDirection:'row', justifyContent:'center',flexWrap:'wrap',marginBottom:20}}>
                        <View style={{width:'33%'}}>
                            <TouchableOpacity onPress={()=>this.props.navigation.push('NewestScreen',{id:378})}>
                                <Text style={styles.text}>Chandigarh-city</Text>
                                <View style={{margin:5}}>
                                    <Image
                                        style={styles.image}
                                        source={require('../../../images/districtimages/chandigarhcity.jpg')}
                                    />
                                </View>
                            </TouchableOpacity>
                        </View>
                        <View style={{width:'33%'}}>
                            <TouchableOpacity onPress={()=>this.props.navigation.push('NewestScreen',{id:520})}>
                                <Text style={styles.text}>ChandigarhAirport</Text>
                                <View style={{margin:5}}>
                                    <Image
                                        style={styles.image}
                                        source={require('../../../images/districtimages/chandigarhairport.jpg')}
                                    />
                                </View>
                            </TouchableOpacity>
                        </View>
