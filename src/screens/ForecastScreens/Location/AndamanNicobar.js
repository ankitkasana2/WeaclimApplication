...
class AndamanNicobar extends Component {
  render() {
    return (
      <View style={{flex: 1}}>
        <HeaderForecast name={'Andaman Nicobar'} />
        <LinearGradient
          ...
          <ScrollView>
            <View
              ...
              <View style={{width: '33%'}}>
                <TouchableOpacity
                  onPress={() =>
                    this.props.navigation.push('NewestScreen', {id: 477})
                  }>
                  <Text style={styles.text}>CarNicobar</Text>
                  <View style={{margin: 5}}>
                    <Image
                      style={styles.image}
                      source={require('../../../images/districtimages/nicobar.jpg')}
                    />
                  </View>
                </TouchableOpacity>
              </View>
              <View style={{width: '33%'}}>
                <TouchableOpacity
                  ...
                  <Text style={styles.text}>PortBlair</Text>
                  <View style={{margin: 5}}>
                    <Image
                      style={styles.image}
                      source={require('../../../images/districtimages/portblair.jpg')}
                    />
                  </View>
                </TouchableOpacity>
              </View>
