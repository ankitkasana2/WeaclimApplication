...
class ArunachalPradesh extends Component{
    render(){
        return(
            <View style={{flex:1}}>
                <HeaderForecast name={"Arunachal Pradesh"}/>
                <LinearGradient
          ...
          style={{flex: 1}}>
                <ScrollView>
                    <View style={{flexDirection:'row',justifyContent:'center',flexWrap:'wrap',marginBottom:20}}>
                        <View style={{width:'33%'}}>
                            <TouchableOpacity onPress={()=>this.props.navigation.push('NewestScreen',{id:357})}>
                                <Text style={styles.text}>Anni</Text> 
                                <View style={{margin:5}}>
                                    <Image
                                    style={styles.image}
                                    source={require('../../../images//districtimages/anni.jpg')}
                                    />
                                </View>
                            </TouchableOpacity>
                        </View>
                        <View style={{width:'33%'}}>
                            <TouchableOpacity onPress={()=>this.props.navigation.push('NewestScreen',{id:358})}>
                                <Text style={styles.text}>Itanagar</Text> 
                                <View style={{margin:5}}>
                                    <Image
                                    style={styles.image}
                                    source={require('../../../images/districtimages/itanagar.jpg')}
                                    />
                                </View>
                            </TouchableOpacity>
                        </View>
                        <View style={{width:'33%'}}>
                            <TouchableOpacity onPress={()=>this.props.navigation.push('NewestScreen',{id:359})}>
                                <Text style={styles.text}>Tawang</Text> 
                                <View style={{margin:5}}>
                                    <Image
                                    style={styles.image}
                                    source={require('../../../images/districtimages/tawang.jpg')}
                                    />
                                </View>
                            </TouchableOpacity>
                        </View>
