...
const data = [
  {
    ...
    src: require('../../../images/eurasia/rainfall24.png'),
  ...
  },
  {
    ...
    // src: require('../../../images/eurasia/cloud24.jpeg'),

    src: require('../../../images/eurasia/cloud24.png'),
  ...
  },
  {
    ...
    src: require('../../../images/eurasia/lowlevel.png'),
    navigateTo: 'NewestScreen',
  },
  {
    id: 235,
    heading: 'Upper Level Divergence',
    src: require('../../../images/eurasia/upperlevel.png'),
    navigateTo: 'NewestScreen',
  },
  {
    id: 236,
    heading: 'Winds at 200hPa',
    src: require('../../../images/eurasia/wind200.png'),
    navigateTo: 'NewestScreen',
  },
  {
    id: 237,
    heading: 'Winds at 500hPa',
    src: require('../../../images/eurasia/wind500.png'),
    navigateTo: 'NewestScreen',
  },
  {
    id: 238,
    heading: 'Winds at 700hPa',
    src: require('../../../images/eurasia/wind700.png'),
    navigateTo: 'NewestScreen',
  },
  {
    id: 239,
    heading: 'Winds at 850hPa',
    src: require('../../../images/eurasia/wind850.png'),
    navigateTo: 'NewestScreen',
  },
  {
    id: 240,
    heading: 'Mean sea level Pressure',
    src: require('../../../images/eurasia/meansealevel.png'),
    navigateTo: 'NewestScreen',
  },
  // {
  //     id: 241,
  //     heading: 'Maximum Temperature',
  //     src: require('../../../images/eurasia/maxtemp.png'),
  //     navigateTo: 'NewestScreen'
  // },
  // {
  //     id: 242,
  //     heading: 'Minimum Temperature',
  //     src: require('../../../images/eurasia/mintemp.png'),
  //     navigateTo: 'NewestScreen'
  // },
];

class EurasiaForecastScreen extends Component {
  render() {
    return (
      <View style={{flex: 1}}>
         <LinearGradient
          ...
          <View style={{flex: 1}}>
            <View
              ...
              <View>
                ...
                <TouchableOpacity
                  onPress={() =>
                    this.props.navigation.push('NewestScreen', {id: 241})
                  }>
                  <Image
                    style={styles.image1}

                    // source={require('../../../images/eurasia/maxtemp.jpeg')}

                    source={require('../../../images/eurasia/maxtemp.png')}
              ...
              <View>
                ...
                <TouchableOpacity
                  onPress={() =>
                    this.props.navigation.push('NewestScreen', {id: 242})
                  }>
                  <Image
                    style={styles.image1}

                    // source={require('../../../images/eurasia/mintemp.jpeg')}

                    source={require('../../../images/eurasia/mintemp.png')}
...
export default EurasiaForecastScreen;
