...
const data = [
  {
    ...
    src: require('../../../images/world/rainfall24.png'),
  ...
  },
  {
    ...
    // src: require('../../../images/world/cloud24.jpeg'),

    src: require('../../../images/world/cloud24.png'),
  ...
  },
  {
    ...
    src: require('../../../images/world/lowlevel.png'),
    navigateTo: 'NewestScreen',
  },
  {
    id: 313,
    heading: 'Upper Level Divergence',
    src: require('../../../images/world/upperlevel.png'),
    navigateTo: 'NewestScreen',
  },
  {
    id: 314,
    heading: 'Winds at 200hPa',
    src: require('../../../images/world/wind200.png'),
    navigateTo: 'NewestScreen',
  },
  {
    id: 315,
    heading: 'Winds at 500hPa',
    src: require('../../../images/world/wind500.png'),
    navigateTo: 'NewestScreen',
  },
  {
    id: 316,
    heading: 'Winds at 700hPa',
    src: require('../../../images/world/wind700.png'),
    navigateTo: 'NewestScreen',
  },
  {
    id: 317,
    heading: 'Winds at 850hPa',
    src: require('../../../images/world/wind850.png'),
    navigateTo: 'NewestScreen',
  },
  {
    id: 318,
    heading: 'Mean sea level Pressure',
    src: require('../../../images/world/meansealevel.png'),
    navigateTo: 'NewestScreen',
  },
  // {
  //     id: 319,
  //     heading: 'Maximum Temperature',
  //     src: require('../../../images/world/maxtemp.png'),
  //     navigateTo: 'NewestScreen'
  // },
  // {
  //     id: 320,
  //     heading: 'Minimum Temperature',
  //     src: require('../../../images/world/mintemp.png'),
  //     navigateTo: 'NewestScreen'
  // },
];

class WorldForecastScreen extends Component {
  render() {
    return (
      <View style={{flex: 1}}>
      <LinearGradient
          ...
          <View style={{flex: 1}}>
            <View
              ...
              <View>
                ...
                <TouchableOpacity
                  onPress={() =>
                    this.props.navigation.push('NewestScreen', {id: 319})
                  }>
                  <Image
                    style={styles.image1}

                    // source={require('../../../images/world/maxtemp.jpeg')}

                    source={require('../../../images/world/maxtemp.png')}
              ...
              <View>
                ...
                <TouchableOpacity
                  onPress={() =>
                    this.props.navigation.push('NewestScreen', {id: 320})
                  }>
                  <Image
                    style={styles.image1}

                    // source={require('../../../images/world/mintemp.jpeg')}

                    source={require('../../../images/world/mintemp.png')}
...
export default WorldForecastScreen;
