...
import { getUrl, postHttp, putHttp } from '../common/WooComFetch'
import { connect } from 'react-redux'
import Toast from 'react-native-easy-toast'
import Spinner from 'react-native-loading-spinner-overlay'
import { appTextStyle } from '../common/Theme.style'
import Ionicons from 'react-native-vector-icons/Ionicons'
import { REGISTER_USER } from '../redux/actions/actions'
...
class CreateAccount extends Component {
  ...
  updateInfo = async () => {
    ...
    const json = await postHttp('customers/' + this.props.userData.id, data)
    this.props.guestFun(json.data, this)
    this.setState({
      password_confirmation: '',
      password: '',
      spinnerTemp: false
    })
    this.toast.show(json.data.status)
  }
