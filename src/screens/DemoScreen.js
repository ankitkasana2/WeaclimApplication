...
class RewardPoints extends PureComponent {
  ...
  updateCurrency (item) {
    this.props.setCurrencyIdFun(item.name,
      ...
      item.position,
      item.code)
    this.props.setSelectedCurrency(item.name, this)
  }
                      ...
                      {item.item.name !== '' &&
                        ...
                        item.item.name !== undefined ? (
                          ...
                          <Text
                            ...
                            {item.item.description + ' (' + item.item.code + ') '}
                          </Text>
                        )}
                    </Body>
                    <CheckBox
                      onPress={() =>
                        this.setState({ spinnerTemp: true }, () =>
                          this.updateCurrency(item.item))} color={this.props.themeStyle.primary}
                      checked={this.state.selectedCurrency === item.item.name}
                    />
                  </TouchableOpacity>
                </ListItem>
              </View>
