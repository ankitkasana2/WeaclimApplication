...
import { getThumbnailImage, getUrl, postHttp } from '../../common/WooComFetch'
  ...
  render () {
    ...
    return this.state.activityIndicatorTemp ? (
      ...
      <View
        ...
        <Header searchIcon={true} menuIcon={true} cartIcon={true} name={theme.homeTitle} navigation={this.props.navigation} />
        ...
        <FlatList
          ...
          ListHeaderComponent={
            <View style={styles.headerListStyle}>
              ...
              {this.categoryHeading(
                this.props.language['NEW ARRIVALS']
              )}
                  ...
                  this.props.banners.length > 0 ? (
                    <TouchableOpacity
                      ...
                      <ImageLoad
                        ...
                        source={{
                          uri: this.props.banners[0].banners_image !== undefined
                            ? this.props.banners[0].banners_image.toString().startsWith('https')
                              ? this.props.banners[0].banners_image.toString()
                              : this.props.banners[0].banners_image.toString().replace('http', 'https')
                            : ''
                        }}
                      />
                    </TouchableOpacity>
              ...
              {/* <View style={{ paddingTop: 0, marginBottom: -16 }}>
                {this.categoryHeading(
