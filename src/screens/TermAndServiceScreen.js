...
class TermAndCon extends PureComponent {
  ...
  componentDidMount () {
    this.props.navigation.setParams({
      headerTitle: this.props.language['Term and Services'],
  ...
  constructor (props) {
    ...
    this.state = {
      isLoading: false,
      spinnerTemp: false,
      termServices: this.props.settings
    }
  }
    ...
    return (
      this.state.spinnerTemp ? (
        ...
        <ScrollView showsVerticalScrollIndicator={false} style={{
          ...
          {this.state.termServices !== undefined && this.state.termServices !== ''
            ? <View>
              <HTML
                html={this.state.termServices}
                baseFontStyle={{
...
const getSettings = (state) => state.settingsCall.termServices
