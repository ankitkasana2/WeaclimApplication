...
class Fetch extends PureComponent {
  ...
  render () {
    // alert(JSON.stringify(this.props.language.products))
    // alert(JSON.stringify(this.props.allCategories))
    // alert(JSON.stringify(this.state))
    // alert(JSON.stringify(this.state.dataSource))
    return this.state.dataSource.length === 0 || this.state.gridCheck ? (
      !this.props.isEmpty
        ? <View
          style={{
            flex: 1,
