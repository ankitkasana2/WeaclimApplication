...
const PageIndicator = ({ th, selected, language, backgroundColor }) => (
  <View style={[styles.containerDevi, {
    ...
    {circle(th, selected >= 1, language.Address)}
    ...
    {/* {circle(th, selected >= 2, language.Shipping)}
    <View style={[styles.childContainerView, {
      backgroundColor: selected >= 3 ? th.props.themeStyle.primary : th.props.themeStyle.iconPrimaryColor
    }]} /> */}
    {circle(th, selected >= 3, language.Payment)}
    <View style={[styles.childContainerView, {
      backgroundColor: selected === 4 ? th.props.themeStyle.primary : th.props.themeStyle.iconPrimaryColor
    }]} />
    {circle(th, selected === 4, language.Review)}
  </View>
)
