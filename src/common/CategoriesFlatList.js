...
class FlatListView extends Component {
  ...
  componentDidMount () {
    // alert(JSON.stringify(this.props.props.navigation.state.params))
    // alert(JSON.stringify(this.props.getAllCategoriesData))
    // alert(JSON.stringify(this.props.categoryPage))
...
const getAllCategoriesFun = createSelector(
  [getAllCategories],
  (getAllCategories) => {
    // console.log(JSON.stringify(getAllCategories))
